function [trackResults, channel]= trackpll3rd(fid, channel, settings)
...
%% PLL环路更新 -----------------------------------------------------
            ...
            % 环路滤波器的时域公式，是从Z域转换得到
            uo = olduo + (carrError + oldCarrError) * kca1;
            olduo = uo;
            oldCarrError = carrError;
            
            uii = uo / 2 * PDIcarr + carrError * kca2;
            uoo = olduoo + uii + olduii;
            olduii = uii;
           
            carrNco = uoo / 2 + kca3 * carrError;
