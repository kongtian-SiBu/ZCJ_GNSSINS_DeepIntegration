function acqResults = acquisition_L1CA1(longSignal, settings)
...
% 根据采样率和相干积分时间生成CA码
caCodesTable = makeCaTable(settings);   % CA码上采样，其长度 = settings.acqCoIntime * samplesPerCode
